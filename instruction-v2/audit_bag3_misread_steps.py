"""Audit Bag 3 OCR step misreads and substeps; write diagnostics reports."""
...
OUT_DIR = ROOT_DIR / "debug" / "bag3_misread_step_audit"
OUT_JSON = OUT_DIR / "70618_bag3_misread_steps.json"
OUT_TABLE = OUT_DIR / "70618_bag3_misread_steps.tsv"
SUBSTEP_JSON = OUT_DIR / "70618_bag3_substep_numbers.json"
SUBSTEP_TABLE = OUT_DIR / "70618_bag3_substep_numbers.tsv"
...
def main() -> int:
    payload = audit_bag_misread_steps(bag=3)
    substep_payload = audit_bag_substep_numbers(bag=3)
